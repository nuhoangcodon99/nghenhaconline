              ...
              <form id="newpost_acaivippro" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="title" placeholder="Tên Bài Hát">
                  </div>
                  <div class="form-group">
                    <label>Ca sĩ</label>
                    <input type="text" name="casi" class="form-control" id="casi" placeholder="Ca sĩ">
                  </div>
                  <div class="form-group">
                    <label>Mô Tả</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="mp3" class="form-control" id="mp3" placeholder="Link Mp3">
                  </div>
                  <div class="form-group">
                    <label>Độ dài</label>
                    <input type="text" name="dai" class="form-control" id="dai" placeholder="Độ dài">
                  </div>
                  <div class="form-group">
