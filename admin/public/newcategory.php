        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Thể Loại Mới</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thể Loại Mới</h3>
              </div>
              <!-- form start -->
              <form id="newcate_acaivippro" method="post">
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" id="newcate_submit" class="btn btn-primary">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
