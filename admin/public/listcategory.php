...
$jquer = $ACAIVIPPRO->remove("category","`id` = '$delete'");
if($jquer){
    echo " <script> 
      Toast.fire({
        icon: 'success',
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><button type="button" class="btn btn-block btn-default btn-sm"><?=number_format($total);?> Bài</button></td>
                    ...
                    <div class="dropdown-menu" role="menu" style="">
                      <a class="dropdown-item" href="?action=editcategory&id=<?=$row['id'];?>">Chỉnh Sửa</a>
                      <a class="dropdown-item" href="#"></a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="?action=listcategory&delete=<?=$row['id'];?>" onclick="return checkDelete()">Xóa bài</a>
                    </div>
                  </div></td>
                  </tr>
                  <?php endforeach; ?>
