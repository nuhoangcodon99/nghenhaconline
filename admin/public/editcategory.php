...
$get = !empty($_GET['id']) ? xss($_GET['id']) : '';
 ...
 if (!$ACAIVIPPRO->get_row("SELECT * FROM `category` WHERE `id`='$get'")){
     header("location: home.html");
     die();
 }
 $row = $ACAIVIPPRO->get_row("SELECT * FROM `category` WHERE `id`='$get'");
?>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sửa Thể loại #<?=$get;?></h3>
              </div>
              <!-- form start -->
              <form id="editcategory_acaivippro" method="post">
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" id="editcategory_submit" class="btn btn-primary">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
